...
|---|---:|---:|---:|
| **FastAhoCorasick — ILP ×8** | **0.027 ms** | **2,465 MB/s** | **0** |
| FastAhoCorasick — serial | 0.153 ms | 434 MB/s | 0 |
...
| | Rust `aho-corasick` | `AhoCorasick.jl` 0.1.1 | **FastAhoCorasick** |
|---|:---:|:---:|:---:|
